 ...
 * Only one fluid can be accepted, which must be specified with {@link SingleUseTankForge#setAcceptedFluid(Fluid)}.
 * Based on the Buildcraft SingleUseTank.
 *
 * @author rubensworks
 *
 */
public class SingleUseTankForge extends TankForge {
     ...
     */
    public SingleUseTankForge(int capacity) {
        super(capacity);
