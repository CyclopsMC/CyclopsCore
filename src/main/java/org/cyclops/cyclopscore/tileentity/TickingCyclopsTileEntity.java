...
/**
 * A base class for all the ticking tile entities.
 *
 * This class has an anti-lag mechanism to send updates with {@link TickingCyclopsTileEntity#sendUpdate()}.
 ...
 * @author rubensworks
 */
public class TickingCyclopsTileEntity extends CyclopsTileEntity implements IUpdatePlayerListBox {
    ...
    public TickingCyclopsTileEntity() {
     ...
     * This does the same as {@link TickingCyclopsTileEntity#sendUpdate()} but will
    ...
    /**
     * Override this method instead of {@link TickingCyclopsTileEntity#update()}.
