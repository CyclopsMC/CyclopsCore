...
public class TestIngredientCollectionConstructors {
    ...
    public void testArrayList() {
        ...
        IngredientArrayList<Integer, Boolean> list4 = new IngredientArrayList<>(IngredientComponentStubs.SIMPLE,Lists.newArrayList(0, 1, 2).iterator());
        ...
        assertThat(list4.containsAll(Lists.newArrayList(0, 1, 2)), is(true));
    }
    ...
    public void testLinkedList() {
        ...
        IngredientLinkedList<Integer, Boolean> list2 = new IngredientLinkedList<>(IngredientComponentStubs.SIMPLE, Lists.newArrayList(0, 1, 2).iterator());
        assertThat(list0.isEmpty(), is(true));
    ...
    public void testHashSet() {
        ...
        IngredientHashSet<Integer, Boolean> list4 = new IngredientHashSet<>(IngredientComponentStubs.SIMPLE, Lists.newArrayList(0, 1, 2).iterator());
        assertThat(list0.isEmpty(), is(true));
        assertThat(list1.isEmpty(), is(true));
        assertThat(list2.containsAll(Lists.newArrayList(0, 1, 2)), is(true));
        assertThat(list3.containsAll(Lists.newArrayList(0, 1, 2)), is(true));
    ...
    public void testTreeSet() {
        ...
        IngredientTreeSet<Integer, Boolean> list2 = new IngredientTreeSet<>(IngredientComponentStubs.SIMPLE, Lists.newArrayList(0, 1, 2).iterator());
        assertThat(list0.isEmpty(), is(true));
        assertThat(list1.containsAll(Lists.newArrayList(0, 1, 2)), is(true));
        assertThat(list2.containsAll(Lists.newArrayList(0, 1, 2)), is(true));
    }
