...
public interface IImage {
     ...
     * @param submitNodeCollector The node collector
     ...
     * @param z Z
     */
    public default void drawWorld(TextureManager textureManager, PoseStack matrixStack, SubmitNodeCollector submitNodeCollector,
                                  int combinedLight, int combinedOverlay, float x1, float x2, float y1, float y2, float z) {
        drawWorldWithAlpha(textureManager, matrixStack, submitNodeCollector, combinedLight, combinedOverlay, x1, x2, y1, y2, z, 1);
    }
    ...
    public default void drawWorld(TextureManager textureManager, PoseStack matrixStack, SubmitNodeCollector submitNodeCollector,
        ...
        drawWorldWithAlpha(textureManager, matrixStack, submitNodeCollector, combinedLight, combinedOverlay, x1, x2, y1, y2, 1);
    }
    ...
    public default void drawWorld(TextureManager textureManager, PoseStack matrixStack, SubmitNodeCollector submitNodeCollector,
        ...
        drawWorldWithAlpha(textureManager, matrixStack, submitNodeCollector, combinedLight, combinedOverlay, x2, y2, 1);
    }
     ...
     */
    public default void drawWorldWithAlpha(TextureManager textureManager, PoseStack matrixStack, SubmitNodeCollector submitNodeCollector,
                                           int combinedLight, int combinedOverlay, float x1, float x2, float y1, float y2, float alpha) {
        this.drawWorldWithAlpha(textureManager, matrixStack, submitNodeCollector, combinedLight, combinedOverlay, x1, x2, y1, y2, 0, alpha);
    }
    ...
    public default void drawWorldWithAlpha(TextureManager textureManager, PoseStack matrixStack, SubmitNodeCollector submitNodeCollector,
        ...
        this.drawWorldWithAlpha(textureManager, matrixStack, submitNodeCollector, combinedLight, combinedOverlay, 0, x2, 0, y2, alpha);
    }
    /**
     * Draw the image in the world.
     * @param textureManager The texture manager.
